  ...
  return (
    <div className="relative w-full sm:h-[85vh] h-[70vh] overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 flex flex-col justify-center items-center text-center text-white px-8 sm:px-16 md:px-24">
        <h1 className="text-4xl sm:text-5xl font-bold mb-4">Software Development</h1>
        <p className="text-lg">
          <Link href="/" className="hover:underline text-white">Home</Link> <span className="text-orange-400">» Software Development</span>
        </p>
      </div>
    </div>
  );
