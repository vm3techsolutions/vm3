        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 sm:gap-8 sm:px-10 px-5 space-y-20 mt-5">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              A design approach that ensure smoth, intuitive interactions & cohesive aestetics across all elements, creating unified user experience
              </p>
            </div>
          </div>
          <div className="flex items-start gap-4">
...
It empowers industries to stay ahead with groundbreaking efficiency & transformative solutons.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Right Content */}
      <div className="sm:w-2/5 relative h-auto lg:h-auto">
        <img
          src="/assets/WhyChoose.jpg" 
          alt="People"
          className="w-full sm:h-full h-[60vh] object-cover"
        />
